...
# just the parameters
root = Tk()
root.title("Shutdown Timer Linux version")
root.geometry("405x125")
...
def start():
	...
	if(rValue == 1): #restart
		...
		messagebox.showerror("Error!", "Type of execution not sellected!")
...
# a custom entry
instruct = Label(middle_frame, text="Insert value", font=fontStyle)
...
selected.set("Minutes")

quantities = OptionMenu(middle_frame, selected, "Minutes", "Hours", "Days")
